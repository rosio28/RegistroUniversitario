...
import com.universidad.registro.model.Rol.NombreRol;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerEstudiante(@RequestBody SignupRequest signUpRequest) {
        ...
        Set<Rol> roles = new HashSet<>();
        Rol userRole = rolRepository.findByNombre(NombreRol.ROL_ESTUDIANTE)
                .orElseThrow(() -> new RuntimeException("Error: Rol no encontrado."));
        roles.add(userRole);
        user.setRoles(roles);
